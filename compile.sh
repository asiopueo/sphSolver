g++ src/main.c src/common.c src/physics.c src/density.c src/loader.c src/marchingcubes.c src/renderer.c -o ./build/sph_alpha -Wall -g -I/usr/include/freetype2 \
